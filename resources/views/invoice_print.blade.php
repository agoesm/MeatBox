            ...
            <div class="col-md-12">
              <table style="width: 100%;">
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="4" class="text-right pr-2" style="background: #efefef;">Total Belanja</td>
                    <td class="text-center" style="background: #efefef;">Rp {{$nota->total_pembelian}}</td>
                  </tr>
                  <tr>
                    <td colspan="4" class="text-right pr-2">PPN 10% </td>
                    <td class="text-center">Rp {{$nota->ppn / 100 * $nota->total_pembelian}}.00</td>
                  </tr>
                  <tr>
                    <td colspan="4" class="text-right pr-2">Total Tagihan</td>
                    <td class="text-center">Rp {{$nota->jumlah_tagihan}}</td>
                  </tr>
                </tbody>
              </table>
            </div>
